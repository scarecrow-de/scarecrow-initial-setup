...
update_distro_name (GisSummaryPage *page)
{
  ...
  if (!name)
    name = g_strdup ("Scarecrow 3");

  /* Translators: the parameter here is the name of a distribution,
   * like "Fedora" or "Ubuntu". It falls back to "Scarecrow 3" if we can't
...
gis_summary_page_class_init (GisSummaryPageClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (GTK_WIDGET_CLASS (klass), "/io/github/scarecrow_de/initial-setup/scis-summary-page.ui");
