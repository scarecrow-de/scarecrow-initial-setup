...
#include "scis-account-page.h"
#include "scis-account-page-local.h"
#include "scis-account-page-enterprise.h"
...
gis_account_page_class_init (GisAccountPageClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (GTK_WIDGET_CLASS (klass), "/io/github/scarecrow_de/initial-setup/scis-account-page.ui");
