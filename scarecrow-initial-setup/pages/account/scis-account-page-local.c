...
#include "scis-page.h"
#include "scis-account-page-local.h"
...
gis_account_page_local_constructed (GObject *object)
{
  ...
  gtk_css_provider_load_from_resource (provider, "/io/github/scarecrow_de/initial-setup/scis-account-page-style.css");
                   ...
                   GError              **error)
{
  ...
  if (parental_controls_enabled) {
     ...
     * according to plan a password will be set on it in scis-password-page.c */
...
gis_account_page_local_class_init (GisAccountPageLocalClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (GTK_WIDGET_CLASS (klass), "/io/github/scarecrow_de/initial-setup/scis-account-page-local.ui");
