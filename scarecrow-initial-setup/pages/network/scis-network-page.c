...
gis_network_page_class_init (GisNetworkPageClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (GTK_WIDGET_CLASS (klass), "/io/github/scarecrow_de/initial-setup/scis-network-page.ui");
