...
gis_privacy_page_constructed (GObject *object)
{
  ...
  priv->privacy_settings = g_settings_new ("io.github.scarecrow_de.desktop.privacy");
...
gis_privacy_page_class_init (GisPrivacyPageClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (GTK_WIDGET_CLASS (klass), "/io/github/scarecrow_de/initial-setup/scis-privacy-page.ui");
